...
async def explain(question, context):
    ...
    payload={"model":AI_MODEL,"messages":[{"role":"system","content":system},{"role":"user","content":json.dumps({"question":question,"computed_context":context},default=str)}],"temperature":0.1,"max_tokens":600}
    try:
